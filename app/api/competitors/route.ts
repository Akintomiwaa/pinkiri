...
export async function POST(request:Request){
 ...
 const secrets=env as unknown as Record<string,string>,google=secrets.GEMINI_API_KEY||process.env.GEMINI_API_KEY,jinaKey=secrets.JINA_API_KEY||process.env.JINA_API_KEY;
